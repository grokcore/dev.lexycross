...
exports = module.exports = function(app, passport) { 
  app.io.get('/',function(r,e) {
        console.log(r,e);
  }); 
  //game end
  app.all('/game/*', require('./views/lexicross').init);
  ...
  app.get('/account/game', require('./views/account/game').init);
  ...
  app.post('/account/settings/', require('./views/account/settings/index').init);
